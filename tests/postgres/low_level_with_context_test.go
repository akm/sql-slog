	...
	t.Run("without tx", func(t *testing.T) {
		...
		for i, name := range testData {
			t.Run("insert "+name, func(t *testing.T) {
				...
				logs.Assert(t, []map[string]interface{}{
					{"level": "VERBOSE", "msg": "Conn.ResetSession Start", connIDKey: connIDExpected},
					{"level": "TRACE", "msg": "Conn.ResetSession Complete", connIDKey: connIDExpected},
					{"level": "TRACE", "msg": "Conn.ExecContext Start", "query": query, "args": fmt.Sprintf("[{Name: Ordinal:1 Value:%d} {Name: Ordinal:2 Value:%s}]", i+1, name), connIDKey: connIDExpected},
		...
		t.Run("select", func(t *testing.T) {
			...
			logs.Assert(t, []map[string]interface{}{
				{"level": "VERBOSE", "msg": "Conn.ResetSession Start", connIDKey: connIDExpected},
				{"level": "TRACE", "msg": "Conn.ResetSession Complete", connIDKey: connIDExpected},
				{"level": "TRACE", "msg": "Conn.QueryContext Start", "query": query, "args": "[{Name: Ordinal:1 Value:ba%}]", connIDKey: connIDExpected},
	...
	t.Run("with tx", func(t *testing.T) {
		t.Run("rollback", func(t *testing.T) {
			...
			t.Run("update", func(t *testing.T) {
				...
				assert.NoError(t, err)
				logs.Assert(t, []map[string]interface{}{
					{"level": "TRACE", "msg": "Conn.ExecContext Start", "query": query, "args": "[{Name: Ordinal:1 Value:qux} {Name: Ordinal:2 Value:3}]", connIDKey: connIDExpected},
		...
		t.Run("commit", func(t *testing.T) {
			...
			t.Run("update", func(t *testing.T) {
				...
				assert.NoError(t, err)
				logs.Assert(t, []map[string]interface{}{
					{"level": "TRACE", "msg": "Conn.ExecContext Start", "query": query, "args": "[{Name: Ordinal:1 Value:quux} {Name: Ordinal:2 Value:3}]", connIDKey: connIDExpected},
