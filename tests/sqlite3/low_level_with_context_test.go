...
func TestLowLevelWithContext(t *testing.T) {
	...
	t.Run("sqlslog.Open log", func(t *testing.T) {
		logs.Assert(t, []map[string]interface{}{
			{"level": "TRACE", "msg": "sqlslog.Open Start", "driver": "sqlite3", "dsn": dsn},
			...
			err := conn.Raw(func(driverConn interface{}) error {
				...
				if assert.Implements(t, (*driver.Conn)(nil), driverConn) {
					...
					t.Run("Begin", func(t *testing.T) {
						...
						require.NoError(t, err)
						logs.Assert(t, []map[string]interface{}{
							{"level": "TRACE", "msg": "Conn.Begin Start", connIDKey: connIDExpected},
					...
					t.Run("Prepare", func(t *testing.T) {
						...
						require.NoError(t, err)
						logs.Assert(t, []map[string]interface{}{
							{"level": "TRACE", "msg": "Conn.Prepare Start", "query": query, connIDKey: connIDExpected},
					...
					t.Run("prepare + Exec", func(t *testing.T) {
						...
						t.Run("Exec", func(t *testing.T) {
							t.Run("success", func(t *testing.T) {
								...
								args := "[4,\"qux\"]"
								logs.Assert(t, []map[string]interface{}{
									{"level": "VERBOSE", "msg": "Stmt.Exec Start", "args": args, connIDKey: connIDExpected, stmtIDKey: stmtIDExpected},
									{"level": "DEBUG", "msg": "Stmt.Exec Complete", "args": args, connIDKey: connIDExpected, stmtIDKey: stmtIDExpected},
								})
								rowsAffected, err := result.RowsAffected()
								assert.NoError(t, err)
								assert.Equal(t, int64(1), rowsAffected)
