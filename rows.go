...
func (r *rowsWrapper) Close() error {
	return r.logger.logAction("Rows.Close", r.original.Close)
}
...
func (r *rowsWrapper) Next(dest []driver.Value) error {
	return r.logger.logAction("Rows.Next", func() error {
...
func (r *rowsNextResultSetWrapper) NextResultSet() error {
	return r.logger.logAction("Rows.NextResultSet", r.original.NextResultSet)
}
